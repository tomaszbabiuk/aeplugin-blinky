...
@Extension
class BlinkerConfigurable(private val eventBus: EventBus, private val portFinder: PortFinder) :
    ...
    private val intervalField =
        NullableBigDecimalField(
            FIELD_INTERVAL,
            R.field_interval_hint,
            BigDecimal.ONE,
            RequiredBigDecimalValidator(),
            IsIntegerValidator()
        )
    ...
    override fun buildAutomationUnit(instance: InstanceDto): AutomationUnit<State> {
        ...
        return BlinkerAutomationUnit(
            eventBus,
            instance,
            name,
            states,
            port,
            interval.wrapped!!.toInt()
        )
    }
