...
This is a plugin for [Automate-Everything](https://github.com/tomaszbabiuk/automate-everything). It provides email sending action.
...
git clone https://github.com/tomaszbabiuk/aeplugin-blinky.git
```
...
```
After running the server, go to http://localhost/plugins/objects and enable "Blinky" plugin
...
Before lunch:
 - run gradle task: aeplugin-blinky:buildForAutomateEverything
